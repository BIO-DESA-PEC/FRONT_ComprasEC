  ...
  // ================================================
    ...
    <div className={`${styles.ocTheme} ${styles.card}`}>
      ...
      <div className={styles.topSection}>
        ...
        {/* Fila 2: días de crédito + modo precios + ordenar por proveedor */}
          ...
          <div className={styles.filtersLeft}>
            <label className={styles.modeItem}>
              ...
              <input
                ...
                min={0}
                value={diasPago}
                onChange={(e) => setDiasPago(Number(e.target.value || 0))}
                placeholder="0"
                disabled={!editable}
              />
            </label>
          ...
          <div className={styles.filtersRight}>
            <label className={styles.modeItem}>
              ...
              <select
                ...
                disabled={!editable}
              >
                <option value="LINEA">Por línea (manual)</option>
                <option value="TOTAL_X_PROV">Total por proveedor</option>
              </select>
            </label>
              ...
              <>
                <label className={styles.modeItem}>
                  ...
                  <input
                    ...
                    value={provTotalTarget}
                    onChange={(e) => setProvTotalTarget(e.target.value)}
                    placeholder="Escribe o selecciona…"
                    disabled={!editable}
                  />
                  <datalist id="proveedoresLista">
                    {[...new Set(
                      detalle.map((r) => r.Proveedor).filter(Boolean)
                    )].map((p) => (
                ...
                <label className={styles.modeItem}>
                  ...
                  <input
                    type="number"
                    step="0.01"
                    value={provTotalMonto}
                    onChange={(e) => setProvTotalMonto(e.target.value)}
                    placeholder="0.00"
                    disabled={!editable}
                  />
                </label>
                ...
                <button
                  className={styles.primary}
                  onClick={aplicarTotalPorProveedor}
                  disabled={!editable}
                >
                  Aplicar
                </button>
